...
순차 실행 전제를 넘어 진짜 동시 실행을 다룬다. 정본 노트: `.recreate/FOLLOWUP-E-concurrency-policy.md`.
...
sadpig70/{Name} --public --source=. --push` → topics 부여 → registry에 `public_repo` 기록.
